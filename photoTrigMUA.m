...
%this function allows to trigger neurophys data to behavioral event codes
%(stim onsets) and get the photodiode onset times to further retrigger the
%data to the photodiode onset times.
